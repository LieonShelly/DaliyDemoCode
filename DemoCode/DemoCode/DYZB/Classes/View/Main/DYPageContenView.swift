...
class DYPageContenView: UIView {
    var tapAction:((_ progress: CGFloat, _ sourceIndex: Int, _ targetIndx: Int) -> ())?
...
extension DYPageContenView: UICollectionViewDataSource {
...
extension DYPageContenView: UICollectionViewDelegate {
